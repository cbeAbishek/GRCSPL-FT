...
import { postcontactform } from "@/components/api/contact"; // Adjust the import based on your API utility location
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="text-center py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mb-6">Thank you for reaching out to us. We will get back to you shortly.</p>
        </div>
        <Button
          onClick={() => setAudioText("")}
          className="bg-[#39b54b] hover:bg-[#2da03e] text-white px-6 py-2"
        >
